...
export type SignInMutationMutationVariables = {
  email: Scalars['String'],
  password: Scalars['String']
};
...
export const SignInMutationDocument = gql`
  ...
  signinUser(email: $email, password: $password) {
    ...
    `;
export type SignInMutationMutationFn = ApolloReactCommon.MutationFunction<SignInMutationMutation, SignInMutationMutationVariables>;
export type SignInMutationComponentProps = Omit<ApolloReactComponents.MutationComponentOptions<SignInMutationMutation, SignInMutationMutationVariables>, 'mutation'>;

    export const SignInMutationComponent = (props: SignInMutationComponentProps) => (
      <ApolloReactComponents.Mutation<SignInMutationMutation, SignInMutationMutationVariables> mutation={SignInMutationDocument} {...props} />
    );
    
export type SignInMutationMutationResult = ApolloReactCommon.MutationResult<SignInMutationMutation>;
export type SignInMutationMutationOptions = ApolloReactCommon.BaseMutationOptions<SignInMutationMutation, SignInMutationMutationVariables>;
